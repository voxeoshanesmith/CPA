...
initialCallerMessage = (not initialMessage)  ? message : initialMessage
initialCallerMessageType = (not initialMessageType)  ? "tts" : initialMessageType
...
outboundCallerID = (not callerID)  ? "13971234567" : callerID
cpaMaxSilence = (not maxSilence)  ? "900" : maxSilence
cpaMaxTime = (not maxTime)  ? "6000" : maxTime
cpaRunTime = (not runTime)  ? "30000" : runTime
numberToCall = (not numberToCall) ? "+14075551234" : "+" + numberToCall
